...
import jp.ac.meijou.android.s251205043.databinding.ActivityMain5Binding;
import jp.ac.meijou.android.s251205043.databinding.ActivityMain6Binding;
...
public class MainActivity6 extends AppCompatActivity {
    ...
    private void updateIpAddress(Network network) {
        ...
        if (linkProperties != null) {
            ...
            binding.textAddress.setText(ipAddresses);
        }
    }
